      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-2 ml-auto">
            ...
            <div className="social-section text-md-left">
              <ul className="text-center">
                <li>
                  <a href="true" className="btn-floating  btn-fb waves-effect waves-light">
                    <i className="fa fa-facebook" />
                  </a>
                </li>
                <li>
                  <a href="true" className="btn-floating  btn-ins waves-effect waves-light">
                    <i className="fa fa-instagram" />
                  </a>
                </li>
                <li>
                  <a href="true" className="btn-floating  btn-tw waves-effect waves-light">
                    <i className="fa fa-twitter" />
                  </a>
                </li>
                <li>
                  <a href="true" className="btn-floating  btn-yt waves-effect waves-light">
                    <i className="fa fa-youtube" />
                  </a>
                </li>
                <li>
                  <a href="true" className="btn-floating  btn-li waves-effect waves-light">
                    <i className="fa fa-linkedin" />
                  </a>
                </li>
                <li>
                  <a href="true" className="btn-floating  btn-dribbble waves-effect waves-light">
                    <i className="fa fa-dribbble left" />
                  </a>
                </li>
                <li>
                  <a href="true" className="btn-floating  btn-pin waves-effect waves-light">
                    <i className="fa fa-pinterest" />
                  </a>
                </li>
                <li>
                  <a href="true" className="btn-floating  btn-gplus waves-effect waves-light">
          ...
          <div className="col-lg-2">
            ...
            <ul>
              <li>
                <a href="true">Store Delivery</a>
              </li>
              <li>
                <a href="true">Online Delivery</a>
              </li>
              <li>
                <a href="true">Delivery Terms &amp; Conditions</a>
              </li>
              <li>
                <a href="true">Tracking</a>
              </li>
            </ul>
          </div>
          <div className="col-lg-2">
            ...
            <ul>
              ...
              <li>
                <a href="true">Return Policy</a>
              </li>
              <li>
                <a href="true">Product Registration</a>
              </li>
            </ul>
          </div>
